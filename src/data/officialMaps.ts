...
export const OFFICIAL_METRO_MAPS: Record<string, OfficialMapData> = {
  hyderabad: {
    ...
    mapTitle: 'Official Hyderabad Metro Rail (HMR) Network Map',
    description: 'The world’s largest Public-Private Partnership (PPP) metro transit system, featuring 3 elevated corridors spanning 69 km with state-of-the-art CBTC signaling and 57 operational stations.',
    officialPortalUrl: 'https://www.ltmetro.com/',
    pdfDownloadUrl: 'https://www.ltmetro.com/our-network/',
    localMapImage: 'maps/hyderabad_official_map.png',
    localMapPdf: 'maps/hyderabad_official_map.pdf',
  ...
  bangalore: {
    ...
    mapTitle: 'Official Metro Map 2025 Bengaluru City (BMRCL)',
    description: 'Bengaluru’s pride transit network connecting Whitefield tech hub to Challaghatta, and North Bengaluru to South Bengaluru, plus upcoming Yellow, Pink and Airport Blue lines.',
    officialPortalUrl: 'https://english.bmrc.co.in/',
    pdfDownloadUrl: 'https://english.bmrc.co.in/',
    localMapImage: 'maps/bengaluru_official_map.png',
    localMapPdf: 'maps/bengaluru_official_map.pdf',
    ...
    operationalCorridors: [
      ...
      { name: 'Yellow Line (Upcoming)', color: '#FBC02D', terminals: 'RV Road ⇄ Bommasandra (Electronic City)', stationsCount: 16 }
    ],
    majorInterchanges: [
      ...
      { name: 'RV Road Interchange', connectingLines: ['Green Line', 'Yellow Line'], description: 'Crucial interchange linking South Bengaluru to Electronic City tech corridor.' },
      { name: 'Jayadeva Hospital', connectingLines: ['Yellow Line', 'Pink Line'], description: 'Multi-tier flyover and double-decker metro intersection.' }
    ]
  },
  mumbai: {
    cityId: 'mumbai',
    ...
    mapTitle: 'Line Map of Mumbai Metro, Mono and Suburban Lines',
    description: 'Rapid transit transformation across Maximum City integrating Line 1 (Versova-Ghatkopar), Line 2A (Yellow), Line 7 (Red), Line 3 (Aqua Line underground), and Mumbai Suburban local railway lines.',
    officialPortalUrl: 'https://www.mmmocl.co.in/',
    pdfDownloadUrl: 'https://www.mmmocl.co.in/',
    localMapImage: 'maps/mumbai_official_map.png',
    localMapPdf: 'maps/mumbai_official_map.pdf',
  ...
  kochi: {
    ...
    authorityShort: 'KMRL',
    mapTitle: 'Official Kochi Metro Route Map (KMRL)',
    ...
    localMapImage: 'maps/kochi_official_map.png',
    localMapPdf: 'maps/kochi_official_map.png',
    ...
    operationalCorridors: [
      { name: 'Line 1 (Northbound & Southbound)', color: '#00A8B5', terminals: 'Aluva ⇄ MG Road ⇄ Vyttila ⇄ SN Junction ⇄ Thrippunithura', stationsCount: 25 }
    ],
    majorInterchanges: [
